...
from ecomadmin.models import CustomUser,MerchantUser,Products,ProductAbout,ProductDetails,ProductMedia,ProductTransaction,ProductTags,StaffUser,CustomerUser
...
class ProductView(View):
    def get(self,request,*args,**kwargs):
        ...
        return render(request,"admin_templates/product_create.html",{"merchant_users":merchant_users})
    ...
    def post(self,request,*args,**kwargs):
        ...
        product=Products(product_name=product_name,in_stock_total=in_stock_total,url_slug=url_slug,brand=brand,product_description=product_description,product_max_price=product_max_price,product_discount_price=product_discount_price,product_long_description=long_desc,added_by_merchant=merchant_user_obj)
        product.save()
...
class ProductEdit(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        return render(request,"admin_templates/product_edit.html",{"product":product,"product_details":product_details,"product_about":product_about,"product_tags":product_tags})
